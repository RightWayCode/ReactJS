...
import { addValue } from "../redux/slice/calculatorSlice";



const Calculation = () => {
  const calculationData = useSelector((state) => state.calculatorData)
  const dispatch = useDispatch();
  useEffect(() => {
    dispatch(addValue('3'))
  }, [])
  useEffect(() => {
    console.warn("There is a calculation Data value: ", calculationData);
  }, [calculationData])
  ...
  const handleClick = (val) => {
    if (expression === "Error") setExpression(val);
